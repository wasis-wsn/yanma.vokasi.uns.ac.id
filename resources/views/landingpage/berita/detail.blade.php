...
<main id="main">
    ...
    <section
        style="height: 60vh; min-height: 400px; background-size: cover; background-position: center; background-attachment: fixed; position: relative; display: flex; align-items: center; justify-content: center; background-image: url('{{ $berita->gambar ? asset('storage/'.$berita->gambar) : asset('/back/assets/images/Default_News.png') }}');">

        <!-- Overlay -->
        <div style="position: absolute; top: 0; left: 0; right: 0; bottom: 0; background: linear-gradient(45deg, rgba(0,0,0,0.7), rgba(0,0,0,0.3));"></div>

        <!-- Content -->
        <div style="position: relative; z-index: 2; text-align: center; color: white; max-width: 800px; padding: 0 20px;" data-aos="fade-up">
            <h1 style="font-size: 2.5rem; font-weight: bold; margin-bottom: 20px; text-shadow: 2px 2px 4px rgba(0,0,0,0.5);">
                {{ $berita->judul }}
            </h1>
            <div style="font-size: 1.1rem; opacity: 0.9; text-shadow: 1px 1px 2px rgba(0,0,0,0.5);">
            ...
            <div style="background: white; border-radius: 10px; box-shadow: 0 4px 20px rgba(0,0,0,0.1); padding: 40px; margin-bottom: 30px;" data-aos="fade-up">
                ...
                <div style="background: #f8f9fa; border: 1px solid #dee2e6; border-radius: 8px; padding: 20px; margin-top: 30px; text-align: center;">
                    <h5 style="margin-bottom: 15px;">
                        <i class="fa fa-file-pdf" style="color: #dc3545;"></i> Dokumen Terlampir
                    </h5>
                    <p style="margin-bottom: 20px; color: #6c757d;">
                        Klik tombol di bawah untuk membuka atau mengunduh dokumen PDF
                    </p>
