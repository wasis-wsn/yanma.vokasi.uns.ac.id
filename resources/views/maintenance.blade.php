...
<body class=" " data-bs-spy="scroll" data-bs-target="#elements-section" data-bs-offset="0" tabindex="0">
    ...
    <div class="wrapper">
        <div class="container-fluid p-0">
            <div class="iq-maintenance text-center"> 
                <img src="{{asset('back/assets/images/error/01.png')}}" class="img-fluid mb-4" alt="">            
                    ...
                    <div class="bg-primary" style="background: transparent; height: 320px;">
                        <div class="gradient-bottom">
                            <div class="bottom-text general-zindex">
                                ...
                                <ul class="countdown d-flex justify-content-center align-items-center list-inline" data-date="Aug 02 2024 14:30:00">
                                    <li>
    ...
    <script src="{{asset('back/assets/js/plugins/countdown.js')}}"></script>
  </body>
</html>