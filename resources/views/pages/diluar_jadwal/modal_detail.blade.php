    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Detail Ajuan Pembayaran UKT Diluar Jadwal</h5>
                ...
                <div class="table-responsive">
                    <table class="table table-borderless table-striped">
                        ...
                        <tr>
                            ...
                            <td>
                                : <a href="" target="_blank" class="btn btn-primary btn-small" id="detail-surat-permohonan"><i class="fa fa-file"></i> Lihat File</a>
                            </td>
                        </tr>
                        <tr>
                            <td>
