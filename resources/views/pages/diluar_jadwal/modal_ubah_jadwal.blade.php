    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Ubah Jadwal Ajuan Pembayaran UKT Diluar Jadwal</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="{{route('diluarJadwal.setting')}}" method="POST" id="form-setting">
                <div class="modal-body">
                    <div class="text-dark">
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="open_datetime">Tanggal Buka:</label>
                            <div class="col-sm-9">
                                <input type="datetime-local" step="1" class="form-control" id="open_datetime" name="open_datetime" value="{{$diluarJadwal->open_datetime}}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="control-label col-sm-3 align-self-center mb-0" for="close_datetime">Tanggal Tutup:</label>
                            <div class="col-sm-9">
                                <input type="datetime-local" step="1" class="form-control" id="close_datetime" name="close_datetime" value="{{$diluarJadwal->close_datetime}}">
                            </div>
                        </div>
                        <div class="form-group row">
