                ...
                <div class="col-xl">
                    <div class="card">
                        <div class="d-flex justify-content-end px-4 pt-2 text-dark">
                            <p>Tahun</p>
                            <div class="dropdown mx-2">
                                <button class="btn btn-light btn-sm dropdown-toggle" type="button" id="tahunCuti"
                                    data-bs-toggle="dropdown" aria-expanded="false">{{ date('Y') }}</button>
                                <ul class="dropdown-menu" aria-labelledby="tahunCuti">
                                    @foreach ($tahuns as $tahun)
                                    <li><a class="dropdown-item tahun-cuti" href="#"
                                            data-year="{{ $tahun->tahun }}">{{ $tahun->tahun }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
                ...
                <div class="col-xl">
                    <div class="card">
                        <div class="d-flex justify-content-end px-4 pt-2 text-dark">
                            <p>Tahun</p>
                            <div class="dropdown mx-2">
                                <button class="btn btn-light btn-sm dropdown-toggle" type="button" id="tahunSuratTugas"
                                    data-bs-toggle="dropdown" aria-expanded="false">{{ date('Y') }}</button>
                                <ul class="dropdown-menu" aria-labelledby="tahunSuratTugas">
                                    @foreach ($tahuns as $tahun)
                                    <li><a class="dropdown-item tahun-surat-tugas" href="#"
                                            data-year="{{ $tahun->tahun }}">{{ $tahun->tahun }}</a></li>
                                    @endforeach
                                </ul>
                            </div>
    ...
    function updateChartsDiluarJadwal(tahun) {
        ...
        $.ajax({
            ...
            success: (res) => {
                ...
                chartDiluarJadwal.options.plugins.title.text =
                    'Grafik Ajuan Pembayaran UKT Diluar Jadwal Tahun ' + tahunDiluarJadwal;
    ...
    function updateChartsSuratTugas(tahun) {
        ...
        $.ajax({
            ...
            success: (res) => {
                ...
                chartSuratTugas.options.plugins.title.text = 'Grafik Ajuan Surat Tugas Delegasi Tahun ' +
                    tahun;
