    ...
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Edit Ajuan Selang</h5>
            ...
            <form action="" method="POST" id="form-edit" enctype="multipart/form-data">
                <div class="modal-body">
                    ...
                    {{-- <div class="form-group">
                        <label class="form-label" for="edit_semester">Semester <span class="text-danger">*</span>:</label>
                        <input class="form-control" id="edit_semester" type="text" name="semester" value="" @readonly(auth()->user()->role == '1')>
                    </div> --}}
                    <div class="form-group">
