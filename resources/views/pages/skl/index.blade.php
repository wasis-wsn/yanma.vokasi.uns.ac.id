                                            ...
                                            <tr>
                                                ...
                                                <td>:
                                                    ...
                                                    @if (auth()->user()->skl->status_id == '2')
                                                        <button type="button" class="btn btn-sm btn-warning btn-edit" data-id="{{ encodeId(auth()->user()->skl->id) }}">Revisi</button>
                                                    @endif
                                                </td>
                                            </tr>
                                            <tr>
...
@push('js')
    ...
    @can('adminprodi')
        <script>
            ...
            window.Laravel = {};
            window.Laravel.TA = {!! json_encode([
                'listData' => route('TA.listAdminProdi'),
                'routeShow' => route('TA.show', ':id'),
            ]) !!};
            window.Laravel.skl = {!! json_encode([
                'baseUrl' => url('/'),
                'export' => route('skl.export'),
                'listData' => route('skl.listAdminProdi'),
                'getData' => route('skl.show', ':id'),
                'routeProses' => route('skl.proses', ':id'),
            ]) !!};
        </script>
        <script src="{{ asset('custom/js/skl/adminprodi.js') }}?q{{Str::random(5)}}"></script>
    @endcan
