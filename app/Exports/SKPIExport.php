...
class SKPIExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    {
        return [
            ['Rekap Data Surat Keterangan Pendamping Ijazah Tahun ' . $this->tahun],
            [],
            [
                'NO',
                'Tanggal Submit',
    ...
    {
        return SKPI::with(['user' => function ($query) {
