...
class DiluarJadwalExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    {
        return [
            ['Rekap Data Pembayaran UKT Diluar Jadwal Tahun Akademik ' . $this->tahun->tahun_akademik . ' - ' . $this->semester->semester],
            [],
            [
                'NO',
                'Tanggal Submit',
    ...
    */
    ...
    {
        return DiluarJadwal::with('user.prodis', 'status')
