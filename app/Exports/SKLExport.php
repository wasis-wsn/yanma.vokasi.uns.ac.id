...
class SKLExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    {
        return [
            ['Rekap Data Surat Keterangan Lulus Tahun ' . $this->tahun],
            [],
            [
                'NO',
                'Tanggal Submit',
    ...
    {
        return SKL::with('user.prodis', 'status')->whereYear('created_at', $this->tahun)->get();
    }
