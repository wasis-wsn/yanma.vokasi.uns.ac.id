...
class SelangExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    {
        return [
            ['Rekap Data Selang Cuti Tahun Akademik ' . $this->tahun->tahun_akademik . ' - ' . $this->semester->semester],
            [],
            [
                'NO',
                'Tanggal Submit',
    ...
    */
    ...
    {
        return SelangCuti::with('user.prodis', 'status')
