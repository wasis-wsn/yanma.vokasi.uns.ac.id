...
class PenundaanExport implements FromCollection, WithHeadings, WithStyles, WithMapping
{
    use Exportable;
    ...
    {
        return [
            ['Rekap Data Penundaan Pembayaran UKT Tahun Akademik ' . $this->tahun->tahun_akademik . ' - ' . $this->semester->semester],
            [],
            [
                'NO',
                'Tanggal Submit',
    ...
    */
    ...
    {
        return Penundaan::with('user.prodis', 'status')
