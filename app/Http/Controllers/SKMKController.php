...
class SKMKController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('pages.skmk.index', compact('tahuns', 'layanan', 'status', 'prodis', 'templates', 'tahunAkademik', 'semester'));
    }
    ...
    public function listMahasiswa()
    {
        ...
        return DataTables::of($data)
            ...
            ->rawColumns(['action', 'created_at', 'tanggal_proses', 'status_id', 'catatan', 'queue_number'])
            ->toJson();
    }
