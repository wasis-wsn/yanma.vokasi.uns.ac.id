...
class SuratTugasController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('pages.surat_tugas.index', compact('tahuns', 'layanan', 'status', 'templates'));
    }
    ...
    public function listMahasiswa()
    {
        ...
        return DataTables::of($data)
            ...
            ->rawColumns(['id', 'created_at', 'tanggal_proses', 'status_id', 'mulai_kegiatan', 'catatan', 'nama_kegiatan'])
            ->toJson();
    }
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'dospem' => ['required'],
            'nip_dospem' => ['required', 'numeric'],
            'nidn_dospem' => ['required', 'numeric'],
