...
let tableRekom = initializeDataTableRekom(typeof status_table !== 'undefined' ? status_table : '', typeof year !== 'undefined' ? year : '');
...
function updateQueueNumbersRekom() {
    $.ajax({
