     ...
     *
     */
    const initializeDataTableTA = (status_table, year, prodi_table) => {
        return $("#ttdTA-datatable").DataTable({
            processing: true,
            serverSide: true,
            destroy: true,
            ajax: {
                url: window.Laravel.TA.listData,
                type: 'GET',
                data: function (d) {
    ...
    let table_ta = initializeDataTableTA(status_table, year, prodi_table);

    $(".tahun-menu").click(function () {
        year = $(this).data("year");
        $("#tahunDropdown").html(year);
        table_ta = initializeDataTableTA(status_table, year, prodi_table);
    });
    ...
    $(".prodi-menu").on("click", function (e) {
        ...
        table.destroy();
        table = initializeDataTableTA(status_table, year, selectedProdi);
    });
