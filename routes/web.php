...
Route::middleware('auth')->group(function () {
    ...
    * * * * * * * * * * * * */
    Route::name('perpanjanganStudi.')->prefix('perpanjanganStudi')->group(function () {
        ...
        Route::get('/listFo', [PerpanjanganStudiController::class, 'listFo'])->name('listFo')->middleware('role:fo,adminprodi');
        ...
        Route::post('/export/data', [PerpanjanganStudiController::class, 'export'])->name('export')->middleware('role:staff,dekanat,subkoor');
        Route::post('/proses/{id}', [PerpanjanganStudiController::class, 'proses'])->name('proses')->middleware('role:staff,fo,adminprodi');
        Route::get('/queue-status', [PerpanjanganStudiController::class, 'queueStatus'])->name('queueStatus');
        Route::get('/update-queue', [PerpanjanganStudiController::class, 'updateQueue'])->name('updateQueue');
        Route::post('/proses/{id}', [PerpanjanganStudiController::class, 'proses'])->name('proses')->middleware('role:staff,fo');
        Route::post('/proses-massal', [PerpanjanganStudiController::class, 'proses'])->name('proses')->middleware('role:staff');;
    });

    Route::name('penundaan.')->prefix('penundaan')->group(function () {
        Route::get('/', [PenundaanController::class, 'index'])->name('index')->middleware('role:mahasiswa,staff,dekanat,subkoor');
        ...
        Route::post('/export/data', [PenundaanController::class, 'export'])->name('export')->middleware('role:staff,dekanat,subkoor');
        Route::post('/store', [PenundaanController::class, 'store'])->name('store')->middleware('role:mahasiswa,staff');
        Route::post('/show/{id}', [PenundaanController::class, 'show'])->name('show')->middleware('role:mahasiswa,staff,dekanat,subkoor');
        ...
        Route::get('/queue-status', [PenundaanController::class, 'queueStatus'])->name('queueStatus');
        Route::get('/update-queue', [PenundaanController::class, 'updateQueue'])->name('updateQueue');
        Route::post('/proses-massal', [PenundaanController::class, 'proses'])->name('proses')->middleware('role:staff');;
    });
    ...
    Route::name('selang.')->prefix('selang')->group(function () {
        ...
        Route::post('/show/{id}', [SelangController::class, 'show'])->name('show')->middleware('role:mahasiswa,staff,dekanat,subkoor,fo');
        ...
        Route::get('/queue-status', [SelangController::class, 'queueStatus'])->name('queueStatus');
        Route::get('/update-queue', [SelangController::class, 'updateQueue'])->name('updateQueue');
        Route::post('/proses-massal', [SelangController::class, 'proses'])->name('proses')->middleware('role:staff');;
    });
    ...
    Route::name('undurDiri.')->prefix('undurDiri')->group(function () {
        ...
        Route::post('/show/{id}', [UndurDiriController::class, 'show'])->name('show')->middleware('role:mahasiswa,staff,dekanat,subkoor,fo');
        ...
        Route::post('/export/data', [UndurDiriController::class, 'export'])->name('export')->middleware('role:staff,dekanat,subkoor');
        Route::post('/proses/{id}', [UndurDiriController::class, 'proses'])->name('proses')->middleware('role:staff,fo');
        Route::post('/proses-massal', [UndurDiriController::class, 'proses'])->name('proses')->middleware('role:staff');;
    });
    ...
    Route::name('diluarJadwal.')->prefix('diluarJadwal')->group(function () {
        ...
        Route::get('/listFo', [DiluarJadwalController::class, 'listFo'])->name('listFo')->middleware('role:fo');
        ...
        Route::post('/show/{id}', [DiluarJadwalController::class, 'show'])->name('show')->middleware('role:mahasiswa,staff,dekanat,subkoor,fo');
        ...
        Route::post('/export/data', [DiluarJadwalController::class, 'export'])->name('export')->middleware('role:staff,dekanat,subkoor');
        Route::post('/proses/{id}', [DiluarJadwalController::class, 'proses'])->name('proses')->middleware('role:staff,fo');
        Route::post('/proses-massal', [DiluarJadwalController::class, 'proses'])->name('proses')->middleware('role:staff');;
    });
    ...
    Route::name('TA.')->prefix('TA')->group(function () {
        Route::get('/', [LembarPengesahanTAController::class, 'listFo'])->name('listFo')->middleware('role:fo,adminprodi');
        Route::get('/listDekanat', [LembarPengesahanTAController::class, 'listDekanat'])->name('listDekanat')->middleware('role:dekanat,subkoor');
        Route::get('/listAdminProdi', [LembarPengesahanTAController::class, 'listAdminProdi'])->name('listAdminProdi')->middleware('role:adminprodi');
    ...
    Route::name('skl.')->prefix('skl')->group(function () {
        ...
        Route::post('/export/data', [SKLController::class, 'export'])->name('export')->middleware('role:staff,dekanat,subkoor');
        Route::post('/store', [SKLController::class, 'store'])->name('store')->middleware('role:mahasiswa');
        Route::post('/show/{id}', [SKLController::class, 'show'])->name('show')->middleware('role:mahasiswa,staff,dekanat,subkoor,fo');
        ...
        Route::post('/proses-massal', [SKLController::class, 'proses'])->name('proses')->middleware('role:staff');;
    });
